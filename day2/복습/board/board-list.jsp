	...
	%>
		...
		<div class="search-area">
			<label>검색어 : <input name="keyword"
				value="<%= keyword != null ? keyword : ""  %>"></label> <input
				type="submit" value="검색"> <select name="kind"
				onchange="fnkind(this.value)">
				<option value="">::전체</option>
				<option value="1" <%=kind.equals("1") ? "selected":" "%>>::공지사항
				</option>
	...
	%>
			<tr>
				...
				<td><a href="javascript:;"
					onclick="fnView(<%= rs.getString("BOARDNO") %>)"><%= rs.getString("TITLE") %></a></td>
